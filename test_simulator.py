...
class TestSimulator(TestCase):
    ...
    def test_get_rules(self):
        ...
        """
        input = "B358/S237"
        self.assertEqual(self.sim.get_rules(input), ([3, 5, 8], [2, 3, 7], 1))
        input = "B3/S2"
        self.assertEqual(self.sim.get_rules(input), ([3], [2], 1))
        input = "3/2"
        self.assertEqual(self.sim.get_rules(input), ([3], [2], 1))
    ...
    def test_update_cell(self):
        ...
        self.sim.set_world(World(3, 3, startAge=5))
        self.sim.world.fill_world(p=[0, 1])  # Vult de wereld volledig, cell zelf leeft ook
        
        cell = self.sim.update_cell(1, 1)
        self.sim.world.set(1, 1, value=cell)
        ...
        cell = self.sim.update_cell(1, 1)
        self.sim.world.set(1, 1, value=cell)
        self.assertEqual(6, cell)  # Test of cell wel tot leven komt, aangezien alleen cellen tussen 2 en 4 vruchtbaar zijn
